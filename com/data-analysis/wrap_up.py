...
# 1.EDA#
df_eda_summary = eda_analysis(missSet=[np.nan, 9999999999, -999999], df=df.df.iloc[:, 0: 3])
...
# Version 1 ##
start = timeit.default_timer()
df_eda_summary = eda_analysis_v1(missSet=[np.nan, 9999999999, -999999], df=df.df.iloc[:, 0: 3])
print("EDA Running Time: {0:.2f} seconds".format(timeit.default_timer()-start))
